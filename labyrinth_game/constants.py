from labyrinth_game.types import Room
...
ROOMS: dict[str, Room] = {
    ...
    "library": {
        ...
        "puzzle": (
            'В одном свитке загадка: "Кто не рад магическим тварям" '
            "(ответ одно слово)",
            "Шрек",
        ),
    },
    ...
    "garden": {
        "description": "Заросший сад с цветами и кустами. В центре стоит фонтан.",
        "exits": {"west": "armory", "north": "cave"},
        "items": ["flower"],
        "puzzle": (
            'На фонтане надпись: "Сколько цветов в радуге?" (ответ цифрой)',
            "7",
        ),
    },
    "cave": {
        "description": "Темная пещера с каплями воды. В глубине виден свет.",
        "exits": {"south": "garden"},
        "items": ["crystal"],
        "puzzle": ('В пещере эхо...', "эхо"),
    },
}
